...
Claude Design is a focused, shareable agent workflow.

## What it does

Design one-off HTML artifacts such as landing pages, decks, and prototypes. Use when the user explicitly requests this capability or a closely related task.
