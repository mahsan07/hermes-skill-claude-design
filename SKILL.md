---
name: hermes-skill-claude-design
description: Design one-off HTML artifacts such as landing pages, decks, and prototypes. Use when the user explicitly requests this capability or a closely related task.
---
